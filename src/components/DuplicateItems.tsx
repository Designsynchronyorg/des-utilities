...
export default class DuplicateItems extends Component {
      ...
      if (structureProps) {
        ...
        Object.keys(structureProps).map((key) => {
          ...
          if (structureProps[key] === Object(structureProps[key])) {
            ...
            let value: any = Object.values(structureProps[key])[0];
            // if value is an object
            if (value === Object(value)) {
              // extract value from the key:value pair
              let innerValue: any = Object.values(structureProps[key])[0];
              // create prop:value pair
              return (props[key] =
                item[1][structureProps[key]][value][innerValue]);
            } else {
  ...
  render() {
    ...
    const functionProps = this.props.functionProps
      ? this.props.functionProps
      : "";
    const structureProps = this.props.structureProps
      ? this.props.structureProps
      : "";
